...
// Verifica si el role_id es 1 o 2 y consulta los empleados, o devuelve un mensaje de error
if ($role_id == 1 || $role_id == 2) {
    ...
    echo json_encode(['error' => 'Usuario no tiene permisos para ver estos empleados']);
}
