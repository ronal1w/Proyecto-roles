...
if ($_SERVER['REQUEST_METHOD'] !== 'PUT' || !isset($data['id'], $data['name'], $data['token'])) {
...
// Verifica si el role_id es 1 y actualiza el rol en la base de datos, o devuelve un mensaje de error
if ($role_id == 1) {
    try {
    ...
    echo json_encode(['error' => 'Usuario no tiene permisos para actualizar un rol']);
}
?>
